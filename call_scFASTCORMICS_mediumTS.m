...
user_path='C:\Users\thomas.sauter\OneDrive - University of Luxembourg\work_other\Projects\Elena_2024\scMetMod'
...
% % % load medium_example
load media
media=[media; 'hdl_hs[e]'; 'nh4[e]'; 'so3[e]'; 'tsul[e]'; 'tag_hs(e)']
...
function_keep.medium=media; %'' %media
function_keep.obj=biomass_reaction;
function_keep.obj=[function_keep.obj; cellfun(@(c)['EX_' c],media,'uni',false)]; %keep all medium
...
temp=setdiff(function_keep.obj,mm.rxns) %remove unconsistent media compoenents from obj
function_keep.obj=setdiff(function_keep.obj,temp);

%%
generic_input_reconstruction=mm;

function_keep.medium=''; %'' %media
